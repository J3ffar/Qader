...
# NEW: Register the ViewSet for partner requests
# Provides /partner-requests/, /partner-requests/{pk}/accept/, etc.
router.register(
    r"partner-requests", views.PartnerRequestViewSet, basename="partnerrequest"
)
...
urlpatterns = [
    ...
    # URL for searching for study partners
    # Example: /community/partners/?name=sa&grade=ثالث ثانوي&section=verbal
    path(
        "partners/",
        views.PartnerSearchView.as_view(),
        name="partner-search-list",
    ),
