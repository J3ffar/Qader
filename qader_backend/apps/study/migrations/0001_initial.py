    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_type', models.CharField(choices=[('level_assessment', 'Level Assessment'), ('practice', 'Practice Set'), ('simulation', 'Full Simulation'), ('custom', 'Custom User Test')], db_index=True, default='practice', max_length=20, verbose_name='test type')),
                ('is_predefined', models.BooleanField(default=False, help_text='If true, uses specific questions linked below. If false, uses configuration rules.', verbose_name='is predefined')),
                ('configuration', models.JSONField(blank=True, help_text='Rules for dynamically generating a test (e.g., num questions per subsection/skill).', null=True, verbose_name='dynamic configuration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('test_configuration', models.JSONField(blank=True, help_text='Configuration used for this specific test instance.', null=True, verbose_name='test configuration snapshot')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('test', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attempts', to='study.test', verbose_name='test definition')),
