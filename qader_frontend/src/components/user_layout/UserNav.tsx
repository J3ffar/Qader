...
const UserNavbar = ({ isOpen }: UserNavbarProps) => {
  ...
  return (
    <div
      className="fixed top-0 flex flex-col bg-white shadow-sm h-auto pr-5 pl-5 transition-all duration-300 z-40 max-md:py-7"
      style={{
        right: isOpen ? 220 : 70,
        left: 0,
      }}
    >
      ...
      <div className="flex items-center h-[70px] max-md:flex-col-reverse max-md:gap-7 max-md:h-full">
        <div className="flex items-center flex-1">
          ...
          <button className="bg-[#074182] text-white p-2 rounded-lg hover:bg-[#053866] transition ml-2">
            <MagnifyingGlassIcon className="w-6 h-6" />
          </button>
        </div>

        {/* Icons */}
        <div className="flex items-center gap-4 pl-2 border-l-1 relative">
          <span
        ...
        <div className="flex items-center gap-3 ml-5 pr-2 relative">
          <span
