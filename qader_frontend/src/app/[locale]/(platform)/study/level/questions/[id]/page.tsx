...
// const attempt_id = 1; // Replace with actual dynamic value if needed
...
//           `https://qader.vip/ar/api/v1/study/attempts/${attempt_id}/`,
...
//               "https://qader.vip/ar/api/v1/auth/token/refresh/",
//               { refresh: refreshToken }
//             );
//             const newAccessToken = refreshResponse.data.access;
//             localStorage.setItem("accessToken", newAccessToken);
...
//         {
//           question_id,
//           selected_answer: String.fromCharCode(65 + selectedAnswer), // A/B/C/D
...
//     try {
//       await axios.post(
//         `https://qader.vip/ar/api/v1/study/attempts/${attempt_id}/complete/`,
//         {},
//         {
//           headers: { Authorization: `Bearer ${accessToken}` },
//         }
//       );
//     } catch (error) {
//       console.error("Complete attempt failed", error);
//     }

//     router.push(`/student/level/questions/${attempt_id}/results`);
//   };
...
//     try {
//       await axios.post(
//         `https://qader.vip/ar/api/v1/study/attempts/${attempt_id}/cancel/`,
//         {},
//         {
//           headers: {
//             Authorization: `Bearer ${accessToken}`,
...
//         }
//       );
//       router.push("/student/level");
//     } catch (error) {
//       console.error("Cancel attempt failed", error);
//     }
//   };
...
//             className="flex items-center gap-2 border border-[#f34b4b] p-2 rounded-lg text-[#f34b4b] font-semibold"
//           >
//             <ArrowRightEndOnRectangleIcon className="w-5 h-5" />
//             انهاء الاختبار
//           </button>
