...
const StudentCommunity: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#081028] p-6 rounded-lg  mx-auto">
      {/* Header */}
      <div className="text-right mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-200">مجتمع الطلاب</h1>
      ...
      {/* Discussion Card */}
      <div className="border border-gray-200 max-w-3xl mx-auto rounded-lg p-4 mb-6">
        {/* Header */}
        <div className="flex justify-between items-center mb-2">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-gray-200 rounded-full"></div>
            <div className="text-right">
              <p className="text-sm font-bold text-gray-800 dark:text-gray-200">بيار سعيد</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">ثالث ثانوي</p>
            </div>
          </div>
        ...
        {/* Text */}
        <p className="text-right text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3 line-clamp-3">
        ...
        <div className="rounded-lg overflow-hidden mb-4">
          <Image
            src="/images/rect.png" // Replace with real image
            alt="discussion"
            width={800}
            height={400}
