...
import { getHomepageFeatures, getHomepageStats } from "@/services/api/admin/content.service";
  ...
  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <div className="space-y-4">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem><BreadcrumbLink href={PATHS.ADMIN.DASHBOARD}>Dashboard</BreadcrumbLink></BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbLink href={PATHS.ADMIN.CONTENT_PAGES_LIST}>Content</BreadcrumbLink></BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>Homepage Management</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <h1 className="text-2xl font-bold">Manage Homepage Content</h1>
        <p className="text-muted-foreground">
          Control the dynamic cards and statistics displayed on the public homepage.
        </p>
        
        <Tabs defaultValue="features" className="w-full">
          <TabsList>
            <TabsTrigger value="features">Feature Cards</TabsTrigger>
            <TabsTrigger value="stats" disabled>Statistics (Coming Soon)</TabsTrigger>
          </TabsList>
