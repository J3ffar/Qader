...
export default function EmergencyModePanel() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen text-gray-800">
      <h2 className="text-xl font-bold mb-2 text-center">وضع الطوارئ</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          <h3 className="font-semibold mb-4">تفعيل وضع الطوارئ</h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow text-center flex flex-col justify-center items-center">
          ...
          <h4 className="font-bold mt-4">حدد عدد الأيام و الساعات</h4>
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          <h3 className="font-semibold mb-4">مشاركة وضعي مع الإدارة</h3>
          ...
          <div className="mb-4">
            ...
            >
              ...
              <option value="تنظيم الوقت">تنظيم الوقت</option>
              <option value="ضغط الدراسة">ضغط الدراسة</option>
            </select>
          </div>
          <div className="mb-4">
            <label className="block mb-1">وصف الطلب</label>
            <textarea
              className="w-full border rounded px-3 py-2"
              rows={4}
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          ...
          <h4 className="font-semibold mb-2">نصائح عامة لك</h4>
